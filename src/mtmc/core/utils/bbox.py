...
from mtmc.core.type.type import Dim2
from mtmc.core.type.type import ListOrTuple2T
...
@multimethod
def bbox_xywh_to_cxcywh_norm(xywh: Tensor, height: float, width: float) -> Tensor:
	"""Convert the bounding box's format from
	[top_left_x, top_left_y, width, height] to
	[center_x_norm, center_y_norm, width_norm, height_norm].
	Where:
...
@multimethod
def bbox_xywh_to_cxcywh_norm(xywh: np.ndarray, height: float, width: float) -> np.ndarray:
	"""Convert the bounding box's format from
	[top_left_x, top_left_y, width, height] to
	[center_x_norm, center_y_norm, width_norm, height_norm].
	Where:
