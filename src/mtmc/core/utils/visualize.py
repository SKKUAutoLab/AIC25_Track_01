...
from det_iden_track.core.data import ClassLabels
from det_iden_track.core.type import Arrays
from det_iden_track.core.utils import concatenate_images
from det_iden_track.core.utils import to_4d_image_list
from det_iden_track.core.utils import to_channel_last
from det_iden_track.core.utils import to_image
from det_iden_track.core.utils import to_pil_image
...
def show_images(
	...
	cat_image = concatenate_images(images, nrow)
	...
	if denormalize:
		from det_iden_track.core.enhance import denormalize_naive
