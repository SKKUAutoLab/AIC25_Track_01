...
# from det_iden_track.core.utils.rich import console
# from det_iden_track.core.utils.rich import print_table
...
class ClassLabels:
	...
	def names(
			self, exclude_negative_key: bool = True, exclude_max_key: bool = True
	) -> list:
	...
	def get_class_label(
			self, key: str = "id", value: Union[int, str, None] = None
	) -> Optional[dict]:
	...
	def print(self):
		...
		if not (self.class_labels and len(self.class_labels) > 0):
			...
			logger.warning("[yellow]No class-label is available.")
			return

		# console.log("[red]Classlabels:")
		# print_table(self.class_labels)
		logger.info(f"Classlabels:")
