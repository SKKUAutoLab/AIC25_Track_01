# ==================================================================== #
# Copyright (C) 2025 - Automation Lab - Sungkyunkwan University
#
...
from det_iden_track.core.utils.rich import console, error_console
...
def get_distance_function(name: str) -> Callable[[np.ndarray, np.ndarray], float]:
	if name in ["chebyshev", "chebyshev_distance", "chebyshev_dist", "chebyshev_func", "chebyshev_function"]:
		...
		error_console.log(f"Wrong distance function name: {name}. Please check!")
		raise ValueError
